...
public class CheckoutSystemTest {
	...
	{
		assertEquals("Invalid Order", CheckoutSystem.processOrder(10.0, -2));
	}
    ...
    public void testDiscountApplication() {
        assertEquals("Total Payable: $99.00", CheckoutSystem.processOrder(10.0, 11)); // $100 total, 10% discount
    }
    ...
    public void testFreeShippingThreshold() {
        assertEquals("Total Payable: $12.00", CheckoutSystem.processOrder(5.0, 2)); // $10 total, no shipping fee
    }
